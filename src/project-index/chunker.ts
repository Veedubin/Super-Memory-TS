...
export class FileChunker {
   ...
   */
  semanticChunk(lines: string[], _filePath?: string): Chunk[] {
    const chunks: Chunk[] = [];
   ...
   */
  slidingWindowChunk(lines: string[]): Chunk[] {
   ...
   */
  private getOverlapLines(chunkLines: string[]): string[] {
   ...
   */
  private createChunk(lines: string[], startLine: number, endLine: number): Chunk {
   ...
   */
  private calculateTokenCount(lines: string[]): number {
 ...
 */
export function createChunker(options?: Partial<ChunkOptions>): FileChunker {
