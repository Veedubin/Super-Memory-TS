...
import { BGE_LARGE_MODEL_ID, MINI_LM_MODEL_ID, BGE_LARGE_DIMENSIONS, MINI_LM_DIMENSIONS, ENV_PRECISION, ENV_DEVICE, ENV_USE_GPU, } from './types.js';
...
export class ModelManager {
     ...
     */
    static createConfig() {
        const envPrecision = process.env[ENV_PRECISION];
        const envDevice = process.env[ENV_DEVICE];
     ...
     */
    async loadModelWithRetry(retries = 3) {
        let lastError = null;
     ...
     */
    selectModel(device = this.config.device) {
